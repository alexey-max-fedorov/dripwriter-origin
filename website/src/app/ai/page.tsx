...
export const metadata: Metadata = {
  ...
  description:
    "Connect Dripwriter to Claude and let AI type your text into Google Docs with human cadence. Step-by-step setup for the Claude Chrome extension and Dripwriter API mode.",
  keywords: [
    "dripwriter ai",
    "dripwriter claude",
