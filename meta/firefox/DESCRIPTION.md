...
_Does Dripwriter Origin work on any website?_
No. Dripwriter Origin is specifically designed for Google Docs documents (docs.google.com/document/*). It does not activate on any other website.

_Does the extension read my Google Docs content?_
No. The extension only receives the text you explicitly paste into its popup. It never reads the content of your Google Docs document.

_Can I stop typing in the middle of a session?_
Yes. Open the Dripwriter Origin popup at any time and press Stop. Typing halts immediately.

_Does Dripwriter Origin collect any personal data?_
...
_What is the typing speed range?_
